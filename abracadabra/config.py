"""
Abracadabra - Konfigurationsmodul
=================================
...
REDDIT_USER_AGENT: str = os.getenv("REDDIT_USER_AGENT", "Abracadabra/2.0")
...
AGGREGATION_WINDOW_MINUTES: int = int(os.getenv("AGGREGATION_WINDOW_MINUTES", "480"))
